...
},{"_process":18,"load-script2":31,"prop-types":36,"react":40}],2:[function(require,module,exports){
"use strict";
...
var videos = [{
  ...
  id: 'ld8ugY47cps',
  name: 'SLCHLD - I can\'t love you anymore'
}, {
  id: null,
  name: '<none>'
}];
...
var hash = typeof window.location !== 'undefined' ? window.location.hash : ''; // eslint-disable-line no-undef
...
function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.handleQuality = _this.handleQuality.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _proto.render = function render() {
    ...
    return _react.default.createElement("div", {
      ...
      className: "col s3"
    }, _react.default.createElement("h3", null, "Video"), _react.default.createElement("div", {
    ...
    })), _react.default.createElement("h3", null, "Paused"), _react.default.createElement("p", null, _react.default.createElement("input", {
      type: "checkbox",
      id: "paused",
      checked: paused,
      ...
      htmlFor: "paused"
    }, "Paused")), _react.default.createElement("h3", null, "Volume"), _react.default.createElement("input", {
      type: "range",
      value: volume,
      min: 0,
      max: 1,
    ...
    }), _react.default.createElement("h3", null, "Quality"), _react.default.createElement("select", {
...
},{"..":1,"react":26,"react-dom":23}],3:[function(require,module,exports){
/**
...
},{"./lib/ReactPropTypesSecret":20}],20:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/emptyFunction":7,"fbjs/lib/emptyObject":8,"fbjs/lib/invariant":12,"fbjs/lib/warning":16,"object-assign":17,"prop-types/checkPropTypes":19}],25:[function(require,module,exports){
/** @license React v16.4.1
...
},{"./emptyFunction":27,"dup":16}],31:[function(require,module,exports){
module.exports = load
...
},{"./lib/ReactPropTypesSecret":37,"dup":19}],34:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
module.exports = function(isValidElement, throwOnDirectAccess) {
    ...
    function checkType(isRequired, props, propName, componentName, location, propFullName, secret) {
      ...
      if (secret !== ReactPropTypesSecret) {
        if (throwOnDirectAccess) {
          ...
          err.name = 'Invariant Violation';
          throw err;
        } else if ("cjs" !== 'production' && typeof console !== 'undefined') {
  ...
  function createEnumTypeChecker(expectedValues) {
    if (!Array.isArray(expectedValues)) {
      "cjs" !== 'production' ? printWarning('Invalid argument supplied to oneOf, expected an instance of array.') : void 0;
  ...
  function createUnionTypeChecker(arrayOfTypeCheckers) {
    if (!Array.isArray(arrayOfTypeCheckers)) {
      "cjs" !== 'production' ? printWarning('Invalid argument supplied to oneOfType, expected an instance of array.') : void 0;
      return emptyFunctionThatReturnsNull;
    }
...
},{"./checkPropTypes":33,"./lib/ReactPropTypesSecret":37,"object-assign":32}],36:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"dup":24,"fbjs/lib/emptyFunction":27,"fbjs/lib/emptyObject":28,"fbjs/lib/invariant":29,"fbjs/lib/warning":30,"object-assign":32,"prop-types/checkPropTypes":33}],39:[function(require,module,exports){
arguments[4][25][0].apply(exports,arguments)
},{"dup":25,"fbjs/lib/emptyFunction":27,"fbjs/lib/emptyObject":28,"fbjs/lib/invariant":29,"object-assign":32}],40:[function(require,module,exports){
arguments[4][26][0].apply(exports,arguments)
},{"./cjs/react.development.js":38,"./cjs/react.production.min.js":39,"dup":26}]},{},[2]);
